...
function Blockchain(){
	...
	this.createNewBlock(100, this.getHash(0), this.getHash(1));
}
...
Blockchain.prototype.getHash = function(value){
...
Blockchain.prototype.chainIsValid= function(blockchain){
	...
	const correctPreviousBlockHash = genesisBlock['previousBlockHash'] === this.getHash(0);
	const correctHash = genesisBlock['hash'] === this.getHash(1);
